    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('settings.export') }}" class="inline-flex items-center px-4 py-2 border border-border rounded-md text-sm font-medium text-foreground bg-white hover:bg-muted transition-colors">
                    <svg class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="bg-white rounded-lg shadow-sm">
            ...
            <div class="p-6">
                <!-- Default view shows company settings -->
                @include('settings.partials.company-form', ['settings' => $settings['company'] ?? [], 'parishes' => [
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <form action="{{ route('settings.import') }}" method="POST" enctype="multipart/form-data" class="flex items-end gap-4">
                @csrf
                <div class="flex-1">
