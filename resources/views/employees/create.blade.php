                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <select name="pay_frequency" id="pay_frequency" class="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                            ...
                            <option value="fortnightly" {{ old('pay_frequency') === 'fortnightly' ? 'selected' : '' }}>Fortnightly</option>
                        </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="pay_type" id="pay_type" class="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" onchange="toggleFlexiRateField()">
                            <option value="salaried" {{ old('pay_type', 'salaried') === 'salaried' ? 'selected' : '' }}>Salaried (Fixed Amount)</option>
                            <option value="hourly_from_salary" {{ old('pay_type') === 'hourly_from_salary' ? 'selected' : '' }}>Hourly (Calculated from Salary)</option>
                            <option value="hourly_fixed" {{ old('pay_type') === 'hourly_fixed' ? 'selected' : '' }}>Flexi-Hour (Fixed Hourly Rate)</option>
                        </select>
                    ...
                    <div class="space-y-2" id="flexi_rate_container" style="display: none;">
                        ...
                        <input type="number" name="flexi_hourly_rate" id="flexi_hourly_rate" value="{{ old('flexi_hourly_rate') }}" step="0.01" class="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="standard_hours_per_period" id="standard_hours_per_period" value="{{ old('standard_hours_per_period') }}" step="0.01" placeholder="Auto-calculated if left blank" class="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary">
